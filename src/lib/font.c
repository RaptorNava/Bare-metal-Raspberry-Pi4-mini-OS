/**
 * font.c — Bitmap шрифт 8x8 для framebuffer
 *
 * Каждый символ занимает 8 байт (8 строк по 8 пикселей).
 * Бит 7 (MSB) = левый пиксель, Бит 0 (LSB) = правый пиксель.
 * Символы с ASCII 32 (пробел) по 126 (~).
 */

#include "../include/font.h"

/* 95 символов: ASCII 32..126 */
